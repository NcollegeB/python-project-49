"""Shared five-level difficulty metadata for browser game runs."""
...
_TIME_LIMITS_MS = {
    ...
    'direction-focus': (8000, 8000, 8000, 8000, 8000),
    'symbol-match': (6000, 7000, 8000, 10000, 12000),
...
DIRECTION_ITEM_COUNTS = (5, 9, 16, 25, 36)
DIRECTION_DIFFERENCES_DEG = (90, 60, 45, 30, 20)

SYMBOL_SEQUENCE_LENGTHS = (1, 2, 3, 4, 6)
